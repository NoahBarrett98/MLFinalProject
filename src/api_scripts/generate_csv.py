# directly taken from https://github.com/douglasrizzo/detection_util_scripts
import argparse
import glob
import json
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "type", metavar="type", default="xml", choices=["xml", "json"], help='"xml" for LabelImg XML or "json" VIA JSON'
    )
    parser.add_argument(
        "input",
        metavar="input",
    ...
    parser.add_argument("output_csv", metavar="output_csv", type=str, help="Path where the CSV output will be created")
