...
if __name__ == "__main__":
    ...
    parser.add_argument("input_file", metavar="input_file", type=str, help="Path to the input txt or csv file")
    parser.add_argument(
        "output_file", metavar="output_file", type=str, help="Path where the .pbtxt output will be created"
    )
